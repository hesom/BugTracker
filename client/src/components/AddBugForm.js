        ...
        <form className="bug-form" onSubmit={handleSubmit}>
            <div className="bug-form-container">
                <div className="bug-form-input">
                    ...
                    <input type="text" name='reporter' id='reporter' value={reporter} onChange={(e) => setReporter(e.target.value)}/>
                    ...
                    <input type="text" name="assigned-to" id="assigned-to" value={assigned} onChange={(e) => setAssigned(e.target.value)}/>
